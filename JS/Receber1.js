document.addEventListener('DOMContentLoaded', function() {
    ...
    let history = [];
    let confirmar; // Mova a declaração para fora da função para que seja acessível em todo o escopo
    ...
    function atualizaTotal(valor) {
        ...
        if (valor != 0) {
            ...
            // Cria o Botão Confirmar - Apenas Permite Que Usuário Passe de Tela Após Inserir Valor
    ...
    function add() {
        ...
        localStorage.setItem('totalSum', total + valor);
